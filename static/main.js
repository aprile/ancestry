...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _getByTag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getByTag */ \"./src/mixins/getByTag.js\");\n\n\nconst getDataByType = (el, type) => {\n  if (!el.tree) return\n  const node = Object(_getByTag__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(el.tree, String(type))[0]\n  const o = {}\n\n  if (node) o.data = node.data\n  return o\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (getDataByType);\n\n\n//# sourceURL=webpack:///./src/mixins/getDataByType.js?");

/***/ }),

/***/ "./src/mixins/getEvent.js":
/*!********************************!*\
  !*** ./src/mixins/getEvent.js ***!
  \********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _getByTag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getByTag */ \"./src/mixins/getByTag.js\");\n\n\nconst getEvent = (el, type) => {\n  if (!el.tree) return\n\n  const node = Object(_getByTag__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(el.tree, type)[0]\n  if (!node) return\n\n  const o = {}\n\n  if (node.data) {\n    o.data = node.data\n  }\n\n  if (node.tree) {\n    const eventDate = Object(_getByTag__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(node.tree, 'DATE')[0]\n    const eventPlace = Object(_getByTag__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(node.tree, 'PLAC')[0]\n\n    if (eventDate) o.date = eventDate.data\n    if (eventPlace) o.place = eventPlace.data\n  }\n\n  return o\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (getEvent);\n\n\n//# sourceURL=webpack:///./src/mixins/getEvent.js?");
